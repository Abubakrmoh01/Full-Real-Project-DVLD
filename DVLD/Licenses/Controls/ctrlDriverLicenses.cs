...
namespace DVLD.Licenses.Local_Licenses.Controls
{
    public partial class ctrlDriverLicenses : UserControl
    {
        ...
        public void LoadInfo(int DriverID)
        {
            ...
            if( _Driver == null )
            {
                MessageBox.Show("there is no driver with id= "+DriverID+ MessageBoxButtons.OK);
                return;
            }
        ...
        public void LoadInfoByPersonID(int PersonID)
        {
            ...
            if( _Driver == null )
            {
                  ...
                  MessageBox.Show("There is no driver link with personID= " + PersonID + MessageBoxButtons.OK);
                return;
